...
<head>
    ...
    <title>AI Breast Cancer Diagnostic Tool</title>
...
<body class="gradient-bg min-h-screen font-sans text-slate-800">
    ...
    <div class="max-w-4xl mx-auto px-4 py-12">
        ...
        <div class="text-center mb-10">
            ...
            <h1 class="text-4xl font-extrabold text-slate-900 mb-2">Breast Cancer Detection AI</h1>
            ...
            <div class="p-8 md:p-12">
                ...
                <div class="mt-8 pt-6 border-t border-slate-100">
                    <div class="flex items-center gap-2 text-amber-600 text-sm">
                        ...
                        <p><strong>Disclaimer:</strong> This is an AI research prototype. Not a substitute for professional medical advice.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <footer class="mt-8 text-center text-slate-400 text-sm">
            <p>&copy; 2024 AI Healthcare Project. Powered by Machine Learning Research.</p>
        </footer>
    </div>
